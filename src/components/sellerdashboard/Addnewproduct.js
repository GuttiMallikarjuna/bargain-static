...
export default function Addnewproduct() {
  ...
  const handleAddAttribute = () => {
    ...
    // Check if the user provided an attribute name and it's not empty
    if (attributeName !== null && attributeName.trim() !== "") {
      const attributeValue = prompt("Enter attribute value:");
  
      // Check if the user provided an attribute value
      if (attributeValue !== null) {
        // Add the attribute
        setCustomAttributes([...customAttributes, { name: attributeName, value: attributeValue }]);
      }
    }
  };
  ...
  const handleSubmit = (event) => {
    ...
    const finalValues = { ...values, ...customAttributes.reduce((acc, cur) => ({ ...acc, [cur.name]: cur.value }), {}) };
...
//                       {/* Your other input fields */}
                      ...
                      //   {customAttributes.map((attr, index) => (
                      //     <div key={index} className="mb-3">
                      //       <label htmlFor={attr.name} className="form-label">{attr.name}</label>
                      //       <input
                      //         type="text"
                      //         className="form-control"
                      //         id={attr.name}
...
// export default function Addnewproduct() {
//   const { values, setValues } = useCart();
//   const [userAttributes, setUserAttributes] = useState([]); // State to store user-added attributes
...
//     // Your existing logic for setting categories based on product type
//   };
...
//                         >
//                           <option value="">Select Product Type</option>
//                           <option value="women" selected readonly>
//                             Women
//                           </option>
//                           <option value="kids">Kids</option>
//                           <option value="jewellery">Jewellery</option>
